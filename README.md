...
Download the executable [here](https://github.com/gaminglemonz/bindwatch/releases/tag/v0.1.0)

### or

to build from source:

Ensure you have Rust installed on your system and run 

```cargo build``` 

for a developer build. For an executable, run 
